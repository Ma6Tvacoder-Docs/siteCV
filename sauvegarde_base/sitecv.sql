...
-- Généré le :  Sam 14 Janvier 2017 à 16:59
...
INSERT INTO `t_experiences` (`id_experience`, `titre_e`, `sous_titre_e`, `dates_e`, `description_e`, `competence_id`, `utilisateur_id`) VALUES
...
--
ALTER TABLE `t_realisations`
  ADD CONSTRAINT `id_utilisateur` FOREIGN KEY (`utilisateur_id`) REFERENCES `t_utilisateur` (`id_utilisateur`) ON DELETE NO ACTION ON UPDATE NO ACTION;
